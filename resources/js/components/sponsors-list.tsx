            ...
            <div className="flex flex-col gap-1">
                ...
                {sponsors.map((sponsor) => (
                    ...
                    >
                        ...
                        <span className="text-sm uppercase text-slate-400 transition-colors group-hover:text-slate-200">
                            {sponsor.domain}
                        </span>
                    </a>
                ))}
                <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="mt-1 flex w-full items-center gap-3 rounded-lg px-2 py-2.5 text-sm uppercase text-slate-600 transition-colors hover:bg-white/5 hover:text-slate-400"
                >
+ Become a sponsor
                </a>
            </div>
        ...
        <div className="flex flex-col items-center space-y-4">
            ...
            {sponsors.map((sponsor) => (
                ...
                >
                    ...
                    <span className="text-base uppercase text-slate-500">{sponsor.domain}</span>
                </a>
            ))}
            <a
                href="https://github.com/sponsors/maherelgamil"
                target="_blank"
                rel="noreferrer"
                className="rounded-lg px-4 py-3 text-base uppercase text-slate-400 transition-colors hover:bg-black/5 hover:text-slate-600"
            >
                + Become a sponsor
            </a>
            </div>
